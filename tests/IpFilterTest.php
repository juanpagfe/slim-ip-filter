...
namespace Jpgfe\Slim\IpFilter\Tests;

use Jpgfe\Slim\IpFilter\IpFilter;
use Slim\Http\Body;
...
class IpFilterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAllowedRouteWithArray()
    {
        $options = array(
            array(
                'ip' => array('192.0.0.0-192.255.255.255', '178.0.0.*'),
    ...
    public function testAllowedRouteWithRange()
    {
        $options = array(
            array(
              'ip' => '192.0.0.0-192.255.255.255',
